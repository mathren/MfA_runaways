...
\begin{frame}[plain]
  \note{I will \textbf{NOT} talk about stars like the Sun}
...
\begin{frame}
  ...
  \begin{textblock}{0.2}[1,1](0.97, 0.88)
    \includegraphics[width=\textwidth]{Gaia_spacecraft_cut_out}
  \end{textblock}
  \begin{textblock}{0.15}[0.5,1](0.8, 0.99)
    \includegraphics[width=\textwidth]{Gaialogo}
  \end{textblock}
...
\begin{frame}{\textcolor{whiteish}{Stars produce their own energy by nuclear fusion}}
      \note{ \textcolor{red}{Nucleosynthesis} deep
...
\begin{frame}[c]
  ...
  \begin{textblock}{1}[0.5,0.5](0.6,0.6)
    \centering
    \only<1>{\includegraphics[width=0.7\textwidth]{onion_sun0.png}} \only<2>{\includegraphics[width=0.7\textwidth]{onion_sun.png}}
  \end{textblock}
  \only<2>{

   \begin{textblock}{0.355}[0,0](0.02,0.15)
    \includegraphics[width=\textwidth]{WD}
  \end{textblock}

  \begin{textblock}{0.355}[0,0](0.03,0.12)
    \begin{center}
      \textcolor{whiteish}{The Sun will turn into a\\
        \textbf{white dwarf}}
    \end{center}
  \end{textblock}
}
...
\begin{textblock}{0.4}[0.5,0.5](0.67,0.56)
  ...
  \begin{textblock}{0.32}[0.,0.5](0.01,0.325)
    ...
    \includegraphics[width=0.78\textwidth]{nucleosynthesis}
  \end{textblock}
...
\begin{frame}{\textcolor{whiteish}{Supernova explosion: the birth Neutron Stars or Black Holes}}
  ...
  \begin{textblock}{1}[0.5,0.5](0.5,0.5)
    ...
    height=0.95\textheight,showcontrols=true,autostart=true]{}{./fig_slides/CCSN_pan.mp4}
  \end{textblock}
  \begin{textblock}{1}[0,1](0.01, 0.99)
...
\begin{frame}
  ...
  \only<3>{
    ...
    (SF) {
      ...
      \centering
      \small
      \hspace*{-10pt}Ionizing radiation
      % \\[-3pt]
...
\begin{frame}
  ...
  \begin{textblock}{0.25}[0, 0](0.03, 0.15)
  ...
  \begin{center}
    \begin{minipage}[hb]{0.25\linewidth}
      \vspace*{-95pt}
      \phantom{\includegraphics[width=\textwidth]{./fig_slides/Zoph}}
    ...
    \begin{minipage}[hb]{0.4\linewidth}
      ...
      \item<1->[$\Leftarrow$] Special features\\
        ...
        \vspace*{5pt}
      \item<2->[] Radial velocities \hfill
        \textcolor{Blue}{$\Rightarrow$}\\
        \only<2->{\small (\textcolor{red}{Doppler shift})}
        \vspace*{5pt}
      \item<3>[] Proper motions\\
        \only<3>{\small (\textcolor{red}{if} distance known)}
        \begin{center}
          \begin{sideways}
            $\Leftarrow$
          \end{sideways}
...
\begin{frame}[c,plain]
  \begin{textblock}{0.5}[0,0](0.01,0.01)
    ...
    \begin{textblock}{0.8}[0.5,0.5](0.5, 0.85)
      ...
      \includegraphics[height=25pt]{Gaia_mission_duration}
    \end{textblock}
\end{frame}
  ...
  \only<4>{
    ...
    \begin{textblock}{0.4}[0.5,0.5](0.75,0.53)
      ...
      \textbf{Core collapse} and possibly \textbf{supernova
        explosion}:\\
      $$\tau(M)\propto M^{-\alpha} \simeq 3-50\,\mathrm{Myr}$$
      \hfill\textcolor{gray!50}{\tiny for $M\gtrsim 7.5\,M_\odot$, e.g., Zapartas et al. 2017}
    \end{textblock}
...
\begin{frame}{Nuclear specific binding energy}
  \centering
  \includegraphics[height=\textheight]{binding_nuc}
\end{frame}
